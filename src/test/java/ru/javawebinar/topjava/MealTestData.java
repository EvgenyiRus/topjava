...
public class MealTestData {
    ...
    public static final Meal mealAdmin1 = new Meal(MEAL_ID+5,LocalDateTime.of(2020, 02, 24, 9, 0), "Завтрак Admin", 200);
    public static final Meal mealAdmin2 = new Meal(MEAL_ID+6,LocalDateTime.of(2020, 02, 24, 13, 0), "Обед Admin", 300);
    public static final Meal mealAdmin3 = new Meal(MEAL_ID+7,LocalDateTime.of(2020, 02, 24, 19, 0), "Ужин Admin", 250);
